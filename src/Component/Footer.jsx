...
const Footer = () => {
    return (
        <footer className="bg-gray-900 py-8 w-full text-center">
            <div className="container mx-auto px-4">
                <div className="flex flex-wrap justify-around">
                    <div className="w-full md:w-1/3 mb-4 md:mb-0 flex justify-center items-center">
                        <h2 className='text-gray-200 text-2xl '>AYUSH BALKRISHNA GHODKE</h2>
                    </div>
                    <div className="w-full md:w-1/3 flex items-center justify-center gap-5">
